...
import ProfileImg from "../assets/images/svg/tia-profile-cartoon.svg";
...
import TiaMainImg from "../assets/images/svg/tia-profile-cartoon.svg";
...
const Home = () => {
  //Text
  const firstTexts = ["Designer", "Dancer", "Baker"];
  const secondTexts = [
    "Designer",
    "Dancer",
    "Baker",
          ...
          <div className="row">
            <div className="col-xxl-6 col-lg-6">
              ...
              <p className="best fade_down">
                Tingkatkan popularitas produk dan media sosial Anda,
                jadikan lebih hits dan dikenal banyak orang!
              </p>
